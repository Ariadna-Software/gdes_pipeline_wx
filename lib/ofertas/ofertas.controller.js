...
router.get('/usuario/:id/:gid/:gid2/:gid3/:gid4/:gid5/:gid6/:gid7', function (req, res) {
    var id = req.params.id;
    var gid = req.params.gid;
    var gid2 = req.params.gid2;
    var gid3 = req.params.gid3;
    var gid3 = req.params.gid3;
    var gid4 = req.params.gid4;
    var gid5 = req.params.gid5;
    var gid6 = req.params.gid6;
    var gid7 = req.params.gid7;
    ofertasDb.getOfertasUsuario(id, gid, gid2, gid3, gid4, gid5, gid6, gid7, function (err, ofertas) {
        if (err) return res.status(500).send(err.message);
        res.json(ofertas);
    });
});
