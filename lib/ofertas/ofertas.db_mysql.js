...
var ofertasDbAPI = {
    ...
    getOfertasUsuario: function (id, gid, gid2, gid3, gid4, gid5, gid6, gid7, done) {
        comun.getConnectionCallback(function (err, con) {
            ...
            sql += " OR o.usuarioId IN (SELECT usuarioId FROM usuarios WHERE grupoUsuarioId = ?)";
            ...
            if (gid2) {
                sql += " OR o.usuarioId IN (SELECT usuarioId FROM usuarios WHERE grupoUsuarioId = + " + gid2 + ")";
            }
            if (gid3) {
                sql += " OR o.usuarioId IN (SELECT usuarioId FROM usuarios WHERE grupoUsuarioId = + " + gid3 + ")";
            }
            if (gid4) {
                sql += " OR o.usuarioId IN (SELECT usuarioId FROM usuarios WHERE grupoUsuarioId = + " + gid4 + ")";
            }
            if (gid5) {
                sql += " OR o.usuarioId IN (SELECT usuarioId FROM usuarios WHERE grupoUsuarioId = + " + gid5 + ")";
            }
            if (gid6) {
                sql += " OR o.usuarioId IN (SELECT usuarioId FROM usuarios WHERE grupoUsuarioId = + " + gid6 + ")";
            }
            if (gid7) {
                sql += " OR o.usuarioId IN (SELECT usuarioId FROM usuarios WHERE grupoUsuarioId = + " + gid7 + ")";
            }                        
