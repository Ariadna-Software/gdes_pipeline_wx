...
var serviciosDbAPI = {
    get: function (done) {
        comun.getConnectionCallback(function (err, con) {
            ...
            sql += " LEFT JOIN areas AS a ON a.areaId = s.areaId ORDER BY s.nombre"
    ...
    getMulti: function (done) {
        comun.getConnectionCallback(function (err, con) {
            if (err) return done(err);
            var sql = "SELECT servicioId, nombre, nombreEN, nombreFR FROM servicios";
