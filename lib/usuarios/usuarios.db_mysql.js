...
var usuariosDbAPI = {
    get: function (done) {
        comun.getConnectionCallback(function (err, con) {
            ...
            var sql = "SELECT u.*, gu.nombre as grupo, u2.nombre as responsable, u2.responsableId as rr2 FROM usuarios as u";
    ...
    getById: function (id, done) {
        comun.getConnectionCallback(function (err, con) {
            if (err) return done(err);
            var sql = "SELECT u.*, gu.nombre as grupo, u2.responsableId as rr2 FROM usuarios as u ";
            sql += " LEFT JOIN grupos_usuarios as gu ON gu.grupoUsuarioId = u.grupoUsuarioId"
            sql += " LEFT JOIN usuarios as u2 ON u2.usuarioId = u.responsableId"
